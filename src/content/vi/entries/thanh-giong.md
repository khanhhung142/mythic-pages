...
locations:
  ...
  - Đền Sóc, Sóc Sơn (Di tích quốc gia 1962)
coordinates:
  - 21.0833
  - 105.9500
relations:
  family:
    - Mẹ Gióng (không rõ tên — người phụ nữ giẫm dấu chân khổng lồ)
    - Cha Gióng (không xuất hiện trong hầu hết bản kể)
  allies:
    - Hùng Vương thứ 6 (vua sai sứ giả tìm người tài)
    - Dân làng Phù Đổng (góp gạo, may áo giáp, nhổ tre)
  enemies:
    - Giặc Ân (kẻ thù không rõ lai lịch lịch sử)
  artifacts:
    - Ngựa sắt (cao mười tám thước)
    - Kiếm sắt (dài bảy thước) — trong bản Lĩnh Nam Chích Quái
    - Roi sắt — trong các bản kể dân gian muộn hơn
    - Áo giáp sắt — bổ sung từ thần tích làng, thế kỷ XVI–XVII
    - Tre đằng ngà (vũ khí khi roi sắt gãy) — motif dân gian
sources:
  - title: Lĩnh Nam Chích Quái
    author: Trần Thế Pháp (soạn TK XIV), Vũ Quỳnh – Kiều Phú (hiệu đính 1492–1493)
    chapter: "Truyện Đổng Thiên Vương"
    notes: "Bản văn bản hoàn chỉnh cốt truyện sớm nhất. KHÔNG có motif mẹ giẫm dấu chân, roi sắt, áo giáp sắt, tre ngà — đây là bổ sung muộn."
  - title: An Nam Chí Lược
    author: Lê Tắc
    edition: "c. 1335"
    notes: "Tài liệu thành văn cổ nhất đề cập 'Xung Thiên Thần Vương.' Chứng tỏ cốt truyện hình thành trước 1285."
  - title: Việt Điện U Linh Tập
    author: Lý Tế Xuyên
    edition: "c. 1329"
    notes: "Ghi thần Phù Đổng là 'thần thổ địa của chùa Kiến Sơ giáng sinh' — lớp văn bản sớm nhất, thần là nhiên thần cây-đá, không phải anh hùng đánh giặc."
  - title: Đại Việt Sử Ký Toàn Thư
    author: Ngô Sĩ Liên
    edition: "Hoàn thành 1479, in Chính Hòa 1697"
    chapter: "Ngoại Kỷ, Kỷ Hồng Bàng Thị"
    notes: "Đưa truyện vào chính sử, ấn định niên đại Hùng Vương thứ 6. Giản lược tối đa yếu tố hoang đường: bỏ Long Quân, bỏ kích thước phi phàm, chỉ còn 'một thanh gươm, một con ngựa.' Không ghi 'giặc Ân' mà chỉ 'trong nước có tin nguy cấp.'"
  - title: Việt Điện U Linh Tục Bổ
    author: Nguyễn Văn Chất
    edition: "TK XV"
    chapter: "Sóc Thiên Vương Sự Tích Ký"
    notes: "Hai dị bản: một kể anh hùng trẻ con diệt giặc, một lấy từ Thiền Uyển Tập Anh kể Tỳ Sa Môn Thiên Vương (Vaiśravaṇa) hiện ra giúp Lê Đại Hành chống Tống 981. Việc đồng nhất hai nhân vật này chỉ là suy đoán."
  - title: Người anh hùng làng Dóng
    author: Cao Huy Đỉnh
    edition: "NXB Khoa học Xã hội, 1969 (truy tặng Giải thưởng Hồ Chí Minh)"
    notes: "Công trình nền tảng. Đề xuất Gióng nguyên thủy là Thần Sấm – Dông – Bão – Mưa, căn cứ liên hệ ngữ âm đổng – dóng – dông."
  - title: "Căn bản triết lý người anh hùng Phù Đổng và hội Gióng"
    author: Trần Quốc Vượng
    edition: "In trong Lễ hội Thánh Gióng, NXB Văn hóa Thông tin 2009, tr. 435–438"
    notes: "Luận điểm Gióng là huyền tích Mặt Trời; ngựa sắt mô phỏng vận động biểu kiến của mặt trời từ Đông sang Tây; 28 nữ tướng giặc Ân tương ứng Nhị thập bát tú."
  - title: Thần, Người và Đất Việt
    ...
    notes: "Sơ đồ tiến hóa rõ nhất: thần cây-đá → Phật giáo Lý-Trần → anh hùng chống ngoại xâm. Kết luận: hình tượng Gióng như chúng ta biết hình thành khoảng 7 thế kỷ trước."
  - title: Les Fêtes de Phù Đổng
    author: Nguyễn Văn Huyên
    edition: "Cahier de la Société de Géographie de Hanoi, XXIV, 1938"
    notes: "Người đầu tiên phân tích Hội Gióng như lễ hội nông nghiệp mang tính phồn thực."
summary: "Thánh Gióng không phải nhân vật lịch sử mà là biểu tượng đa tầng được bồi đắp hơn một thiên niên kỷ: từ nhiên thần cây-đá → thần sấm-mưa nông nghiệp → thần Mặt Trời Đông Sơn → thần hộ pháp Phật giáo → anh hùng chống ngoại xâm. Hội Gióng được UNESCO công nhận Di sản văn hóa phi vật thể đại diện của nhân loại ngày 16/11/2010."
group: Tứ Bất Tử
themes:
  - than-sam-mua
  - mat-troi-dong-son
