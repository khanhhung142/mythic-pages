...
aliases:
  ...
  - Nguyễn Ông Trọng (kiêng húy thời Trần)
...
type: figure
era: "Bối cảnh truyện: cuối Hùng Vương, An Dương Vương, Tần Thủy Hoàng (thế kỷ III TCN). Lớp văn bản: định hình từ thời thuộc Đường (TK VIII-IX), chép thành văn trong Việt điện u linh (1329) và Lĩnh Nam chích quái (cuối TK XIV, hiệu chính 1492-1493)"
region: bac
locations:
  - Xã Thụy Hương, huyện Từ Liêm xưa (nay là phường Thụy Phương, quận Bắc Từ Liêm, Hà Nội)
  - Lâm Thao (臨洮, nay thuộc Cam Túc, Trung Quốc)
  - Thành Hàm Dương, kinh đô nhà Tần
birth_death: "không rõ; truyện đặt vào khoảng thế kỷ III TCN"
dynasty: "thời An Dương Vương (theo khung niên đại của truyện)"
titles:
  - "Tư lệ Hiệu úy (chức Tần, theo truyện)"
  - "Phụ Tín hầu (tước phong trong truyền thuyết)"
  - "Uy Mãnh Anh Liệt Phụ Tín Đại Vương (sắc phong thời Trần)"
  - "Thượng đẳng Phúc thần (triều Lê)"
  - "Hy Khang Thiên Vương (mỹ hiệu phổ biến, triều Nguyễn)"
events:
  - name: "Sang Tần làm quan"
    year: null
    role: "Tư lệ Hiệu úy (theo truyện)"
  - name: "Trấn thủ Lâm Thao, Hung Nô không dám phạm ải"
    year: null
    role: "Tướng trấn biên (theo truyện)"
  - name: "Tần Thủy Hoàng đúc tượng đồng đặt ở cửa Tư Mã, Hàm Dương"
    year: null
    role: "Nhân vật được tạc tượng (theo truyện)"
temples:
  - name: "Đình Chèm (đền Lý Hiệu Úy, Thụy Hương từ)"
    location: "phường Thụy Phương, quận Bắc Từ Liêm, Hà Nội"
  - name: "Đình Ninh Sơn"
    location: "thị trấn Chúc Sơn, huyện Chương Mỹ, Hà Nội"
  - name: "Đình Trạo Thôn"
    location: "huyện Chương Mỹ, Hà Nội"
legend_layer: true
sources:
...
## Bối cảnh: _Âu Lạc giữa hai thế lực_
...
## Hành trạng: _theo chính sử và hai tập truyện cổ_
...
| Yếu tố | *Việt điện u linh* (1329) | *Lĩnh Nam chích quái* (hiệu chính 1493) | *Toàn thư* / *Cương mục* | Bản dân gian (Nguyễn Đổng Chi) |
|--------|--------------------------|------------------------------------------|--------------------------|--------------------------------|
| Tên | Lý Ông Trọng | Lý Thân | Lý Ông Trọng | Ông Trọng |
| Chiều cao | 2 trượng 3 thước | 2 trượng 3 thước | 2 trượng 3 thước | 2 trượng 6 thước |
| Lý do sang Tần | Bị đánh đòn, phẫn chí học, tự sang làm quan | An Dương Vương đưa sang khi Tần dọa đánh | Bị đánh đòn, tự sang làm quan | Bị bắt làm phu, bỏ trốn, giết người, bị đưa sang |
| Vợ là công chúa Tần | Không nhắc | Có | Không nhắc | Không nhắc |
| Motif giết giải tinh | Không | Không | Không | Có (giết giải cứu mẹ, tát nước) |
| Triệu Xương, Cao Biền lập đền | Có | Có | Có | Không |
...
## Ông trọng 翁仲 trong _sử liệu Trung Quốc_
...
## Tranh luận _học thuật_: người thật hay truyền thống được kiến tạo?
