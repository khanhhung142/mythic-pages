...
category: tich-co
subcategories:
  - co-tich-nguon-goc-su-vat
  - truyen-ky
  - truyen-co-tich-lich-su
type: narrative
era: "Bối cảnh truyện: thời Hùng Vương (không rõ đời). Bối cảnh sáng tác: cuối TK XIV (Trần Thế Pháp), biên tập 1492-1493 (Vũ Quỳnh và Kiều Phú)"
region: bac
locations:
...
characters:
  - id: mai-an-tiem
    role: protagonist
    notes: "Nô bộc ngoại quốc được vua nuôi, bị đày vì tuyên bố của cải là vật tiền kiếp"
  - id: null
    name: Vợ Mai An Tiêm
    role: deuteragonist
    notes: "Không tên trong nguyên bản Hán. Truyền khẩu: nàng Ba. Tô Hoài: Nàng Hoa"
  - id: null
    name: Vua Hùng
    role: antagonist-then-redeemer
    notes: "Đày An Tiêm, sau hối hận, gọi về phục chức. Đời thứ mấy không xác định trong nguyên bản"
  - id: null
    name: Chim trắng từ phương Tây
    role: agent-of-providence
    notes: "Mang hạt dưa đến đảo. Là yếu tố thần kỳ duy nhất trong truyện"
contained_in:
  - title: Lĩnh Nam Chích Quái
    position: "Truyện thứ 8 hoặc 9 tùy bản (trong bản 22 truyện của Vũ Quỳnh)"
    author: Trần Thế Pháp (soạn TK XIV), Vũ Quỳnh và Kiều Phú (biên tập 1492-1493)
  - title: Kho tàng truyện cổ tích Việt Nam
    position: "Tập II, truyện số 1, mục 'I. Nguồn gốc sự vật'"
    author: Nguyễn Đổng Chi (1957-1982)
not_contained_in:
  - title: Việt Điện U Linh Tập
    author: Lý Tế Xuyên (1329)
    reason: "Sách chỉ chép thần linh được triều đình phong sắc, không ghi truyện kể nguồn gốc sự vật"
  - title: Đại Việt Sử Ký Toàn Thư
    author: Ngô Sĩ Liên (1479)
    reason: "Phần Hùng Vương chỉ ghi tổng quát, không có mục riêng cho truyện này"
  - title: Khâm Định Việt Sử Thông Giám Cương Mục
    author: Quốc Sử Quán triều Nguyễn (1856-1881)
    reason: "Tương tự Toàn Thư: tổng quát, không có An Tiêm"
  - title: Việt sử lược
    author: Khuyết danh (c. 1377)
    reason: "Sử Việt sớm nhất còn tồn tại. Không có phả hệ chi tiết thời Hùng Vương"
adaptations:
  - title: Quả dưa đỏ
    author: Nguyễn Trọng Thuật (Đồ Nam Tử)
    year: 1925
    type: tiểu thuyết quốc ngữ
    notes: "Một trong những tiểu thuyết quốc ngữ đầu tiên miền Bắc. Giải Khai Trí Tiến Đức 1925. Phụ đề 'phiêu lưu tiểu thuyết.' Đăng Nam Phong tạp chí, in sách 1927. Tái bản NXB Đông A và Dân Trí (2020s)."
  - title: Đảo hoang
    author: Tô Hoài
    year: 1970
    type: tiểu thuyết thiếu nhi
    notes: "NXB Kim Đồng. Vợ: Nàng Hoa, con: Mon, Gái, Mai Li. Mon phát hiện hạt dưa. Tái bản nhiều lần."
  - title: "Cổ tích Việt Nam (phim)"
    author: Đạo diễn Nguyễn Minh Chung
    year: 1995
    type: phim VHS
    notes: "Quang Hải đóng Mai An Tiêm."
  - title: "Bộ tem 'Truyền thuyết Mai An Tiêm'"
    author: Bưu chính Việt Nam
    year: null
    type: tem bưu chính
    notes: "4 mẫu tem + 1 bloc."
sources:
  - title: Lĩnh Nam Chích Quái
    author: Trần Thế Pháp (soạn TK XIV), Vũ Quỳnh và Kiều Phú (biên tập 1492-1493)
...
motifs:
  - code: A2611
    ...
    description: "Nguồn gốc thực vật do thần linh ban cho"
  - code: B450
    system: Thompson Motif-Index
    description: "Chim giúp đỡ (helpful birds)"
  - code: L111.4
    system: Thompson Motif-Index
    description: "Anh hùng bị lưu đày (exiled hero)"
  - code: Q411-variant
    system: Thompson Motif-Index
    description: "Đày làm hình phạt, kết thúc bằng tha thứ"
  - code: N440-N499
    system: Thompson Motif-Index
    description: "Phát hiện may mắn (lucky discoveries)"
  - code: AT-736A-adjacent
    system: Aarne-Thompson
    description: "Vật thả ra biển trở về (Ring of Polycrates, motif gần)"
  - code: null
    system: custom
    description: "Robinson tiền-Defoe: lưu đày đảo hoang, tự lực sinh tồn, tái lập thương mại"
  - code: null
    system: custom
    description: "Folk etymology: giải thích tên gọi 'Tây Qua' qua narrative (chim từ hướng Tây)"
popularity: 5
status: published
...
## _Vị trí_ trong Lĩnh Nam Chích Quái
...
Truyện thuộc thể loại mà Nguyễn Đổng Chi gọi là **"cổ tích lịch sử / cổ tích thần kỳ giải thích nguồn gốc sự vật"**: truyện vừa giải thích một hiện tượng (dưa hấu đến từ đâu?) vừa gắn vào khung lịch sử (thời Hùng Vương). Bùi Duy Tân (_Truyện ngắn Việt Nam_, NXB Giáo dục 2007, tr. 127) gọi nó là **"cổ mẫu"** (archetype) về sự ra đời của văn hóa vật chất, tiếp cận theo phương pháp Địa-Văn hóa (Géo-Culture).
...
## _Không_ có trong chính sử, và ý nghĩa của chỗ vắng mặt
...
## Dưa hấu _thực_: khoa học nói gì
...
**Citrullus lanatus** có nguồn gốc Đông Bắc Phi: vùng Sudan, Ai Cập, Libya. Hạt hoang dã 5.000 năm tuổi tại Uan Muhuggiag, Libya (van der Veen & Wasylikowa 2004). Tranh mộ Pharaoh ~2350 TCN vẽ quả dưa có sọc. Gen gần đây (Renner et al. 2015): tổ tiên gần nhất là dưa Kordofan (_C. lanatus subsp. cordophanus_), Sudan.

Đến Trung Quốc: **Hồ Kiều** (đời Hậu Tấn, bị Khiết Đan giữ 947-953) ghi trong _Hãm Lỗ Ký_: Khiết Đan phá Hồi Cốt (924) được giống dưa, trồng bằng phân trâu, quả to vị ngọt. Đến Trung Nguyên thực sự với **Hồng Hạo** (sứ thần Nam Tống, bị Kim giữ 1129-1143), mang hạt về. Lý Thời Trân tổng kết (_Bản Thảo Cương Mục_ 1578): "Dưa hấu vào Trung Quốc từ đời Ngũ Đại."
...
## Dị bản: _những chỗ_ các bản chép khác nhau
...
## Nghiên cứu _học thuật_: vị trí trong tranh luận lớn hơn
...
**Nguyễn Thị Oanh** (2025) so sánh LNCQ với _Nhật Bản linh dị ký_ (Nihon ryōiki), chứng minh tính "đồng văn" Đông Á trong loại hình ký quái. Tây Qua truyện, với yếu tố "vật tiền kiếp" (khái niệm nghiệp báo), nằm trong quỹ đạo ảnh hưởng Phật giáo chung với các bản ký quái Nhật, Hàn.
