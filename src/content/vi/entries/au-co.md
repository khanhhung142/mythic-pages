...
characters:
  ...
  - id: de-lai
    name: "Đế Lai (帝來)"
    role: supporting
    notes: "Vua phương Bắc dòng Thần Nông, cha Âu Cơ. Phả hệ khớp với Đế Lai (帝來/帝釐), vua thứ sáu họ Thần Nông, cha của Đế Ai (帝哀), trong Đế vương thế kỷ của Hoàng Phủ Mật"
  - id: hung-vuong
    name: "Hùng Vương (雄王)"
    role: successor
...
not_contained_in:
  ...
  - title: Việt điện u linh tập
    ...
    reason: "Chép thần linh được phong sắc, có Sơn Tinh (Tản Viên); bản 27 truyện nguyên tác không có mục Âu Cơ"
  - title: Khâm định Việt sử thông giám cương mục
    author: Quốc sử quán triều Nguyễn (1856-1881)
    reason: "Không chép Kinh Dương Vương và Lạc Long Quân vào chính biên; đưa truyện Hồng Bàng xuống phần phụ chú đầu kỷ Hùng Vương theo lệ truyền nghi, kèm lời phê coi các tích là chuyện trâu ma rắn thần"
adaptations: null
sources:
  - title: Lĩnh Nam Chích Quái
    author: Trần Thế Pháp (soạn TK XIV), Vũ Quỳnh và Kiều Phú (biên tập 1492-1493)
  ...
  - title: Đế vương thế kỷ (帝王世紀)
    ...
    chapter: "Phả hệ họ Thần Nông (Đế Lai, vua thứ sáu, cha Đế Ai)"
summary: |
