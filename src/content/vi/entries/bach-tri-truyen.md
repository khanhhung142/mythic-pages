...
subcategories:
  ...
  - ngoai-giao-co-dai
type: narrative
era: "Bối cảnh truyện: thời Hùng Vương, triều Chu Thành Vương (khoảng 1042-1021 TCN). Bối cảnh sáng tác: cuối TK XIV (Trần Thế Pháp), biên tập 1492-1493 (Vũ Quỳnh và Kiều Phú)"
region: bac
locations:
  - Kinh đô Văn Lang (triều Hùng Vương)
  - Kinh đô Cảo Kinh (鎬京), nhà Tây Chu
  - Đường biển qua Phù Nam, Lâm Ấp
characters:
  - id: hung-vuong
    role: sovereign
    notes: "Vua Văn Lang, sai bề tôi xưng Việt Thường thị sang phương Bắc. Đời thứ mấy không xác định"
  - id: null
    name: Sứ giả Việt Thường thị (越裳氏)
    role: protagonist
    notes: "Bề tôi Hùng Vương, tự xưng Việt Thường thị. Không tên riêng trong nguyên bản"
  - id: null
    name: Chu Thành Vương (周成王)
    role: counterpart
    notes: "Vua nhà Tây Chu. Thực tế trong truyện, người đối thoại chính là Chu Công Đán (nhiếp chính)"
  - id: null
    name: Chu Công Đán (周公旦)
    role: counterpart
    notes: "Nhiếp chính nhà Chu. Người trực tiếp đối thoại với sứ giả, từ chối vị trí bề trên, trích lời Hoàng Đế cấm xâm phạm Giao Chỉ"
contained_in:
  - title: Lĩnh Nam Chích Quái
    position: "Truyện thứ 10 quyển thượng (trong bản 22 truyện của Vũ Quỳnh 1492)"
    author: Trần Thế Pháp (soạn TK XIV), Vũ Quỳnh và Kiều Phú (biên tập 1492-1493)
  - title: Đại Việt Sử Ký Toàn Thư
    position: "Ngoại kỷ Quyển I, Hùng Vương kỷ (bản giản lược)"
    author: Ngô Sĩ Liên (1479)
  - title: Việt Sử Lược
    position: "Phần Hùng Vương (tóm tắt)"
    author: Khuyết danh (c. 1377)
  - title: Khâm Định Việt Sử Thông Giám Cương Mục
    position: "Phần Hùng Vương"
    author: Quốc Sử Quán triều Nguyễn (1856-1881)
not_contained_in:
  - title: Việt Điện U Linh Tập
    author: Lý Tế Xuyên (1329)
    reason: "Sách chỉ chép thần linh được triều đình phong sắc. Việt Thường thị không phải thần linh"
adaptations: null
sources:
  - title: Lĩnh Nam Chích Quái
    author: Trần Thế Pháp (soạn TK XIV), Vũ Quỳnh và Kiều Phú (biên tập 1492-1493)
...
motifs:
  - code: null
    system: custom
    description: "Tìm đạo để học: sứ giả đến tìm thánh nhân, mang văn hoá tặng, không phải triều cống"
  - code: null
    system: custom
    description: "Chim vật tổ: bạch trĩ vừa là điềm lành Trung Hoa vừa là biểu trưng chim vật tổ văn hoá Đông Sơn"
  - code: null
    system: custom
    description: "Tuyên ngôn chủ quyền qua miệng đối phương: Chu Công trích lời Hoàng Đế cấm xâm phạm Giao Chỉ"
  - code: null
    system: custom
    description: "Xe chỉ nam: anachronism (chưa có thời Tây Chu), biểu tượng Chu Công tiễn khách về phương Nam"
  - code: null
    system: custom
    description: "Quên đường về: biểu tượng ảnh hưởng văn hoá Việt Thường bám rễ trên đất Bắc"
  - code: null
    system: custom
    description: "Trùng dịch (重譯): nhiều lần phiên dịch, nhấn mạnh hai nền văn hoá hoàn toàn xa lạ gặp nhau lần đầu"
popularity: 3
status: published
...
## Hai cách đọc: _"triều cống" hay "tìm đạo để học"?_
...
Cách đọc "triều cống" đặt truyện vào khuôn mẫu *Hậu Hán thư* nhưng bỏ qua chính những chi tiết mà tác giả Việt thêm vào. Cách đọc "tìm đạo để học" bám vào cấu trúc nội tại, phù hợp hơn với ý đồ biên soạn mà Vũ Quỳnh trình bày trong Tựa. Bằng chứng văn bản ủng hộ cách đọc thứ hai; các mục dưới đây đọc truyện theo hướng đó.

## Chim trĩ trắng: _vật tổ trong mắt người Việt, điềm lành trong mắt nhà Chu_
...
## Nguồn gốc: _Việt hoá cổ tịch Trung Hoa_
...
## Có trong chính sử, _nhưng giản lược_
...
## Dị bản: _những chỗ các bản chép khác nhau_
...
## Nghiên cứu học thuật: _vị trí trong tranh luận lớn hơn_
...
**Vị trí của entry này.** Về niên đại và tính kiến tạo, chứng cứ đứng về phía Kelley và Taylor: truyện định hình muộn, trên nền cổ tịch Trung Hoa. Nhưng đó là câu hỏi về nguồn gốc văn bản, không phải câu hỏi về ý nghĩa. Về ý nghĩa, bằng chứng nội tại nghiêng hẳn về cách đọc "tìm đạo để học": chính những chi tiết tác giả Việt **thêm vào** so với nguồn Trung Hoa (Chu Công từ chối bề trên, Hoàng Đế cấm xâm phạm, ngôn ngữ bất đồng triệt để) cho thấy người biên soạn không sao chép khung triều cống mà viết lại để phủ nhận nó. Cách đọc của Nguyễn Hữu Vinh và Trần Đình Hoành chưa được đưa vào học thuật phương Tây; entry này theo cách đọc đó.
