...
name_han: 郎僚
aliases:
  - Tiết Liêu / Tiết Lang Liêu (薛郎僚, nhánh ngọc phả và dân gian)
  - Hùng Chiêu Vương (雄昭王, theo ngọc phả 1472)
  - Hoàng tử thứ mười tám
name_en: "Lang Liêu: The Eighteenth Prince"
category: tich-co
subcategories:
  - nhan-vat-truyen-thuyet
  - he-hung-vuong
  - anh-hung-van-hoa
type: figure
era: "Bối cảnh truyện: đời Hùng Vương thứ sáu. Bối cảnh sáng tác: cuối TK XIV (Trần Thế Pháp), biên tập 1492-1493 (Vũ Quỳnh và Kiều Phú)"
region: bac
locations:
  - Phong Châu / Phú Thọ (kinh đô Hùng Vương, nơi thi tài)
  - Hương Trầm, Dữu Lâu, Việt Trì (miếu thờ Lang Liêu theo ngọc phả địa phương)
  - Đền Hùng, Phú Thọ (thờ trong quần thể)
characters:
  - id: lang-lieu
    role: protagonist
    notes: "Con thứ mười tám của Hùng Vương thứ sáu, mẹ phận thấp mất sớm"
  - id: hung-vuong
    role: sovereign
    notes: "Hùng Vương thứ sáu, cha, người ra điều kiện thi tài"
  - id: null
    name: Thần nhân (神人)
    role: helper
...
contained_in:
  - title: Lĩnh Nam Chích Quái
    position: "Chưng Bính truyện (蒸餅傳), quyển I, truyện thứ 8"
  ...
  - title: Hùng Đồ Thập Bát Diệp Thánh Vương Ngọc Phả Cổ Truyền
    position: "Đời thứ bảy: Hùng Chiêu Vương Minh Tông hoàng đế"
    author: Khuyết danh (cấp phát triều Lê Thánh Tông, 1472)
not_contained_in:
  - title: Đại Việt Sử Ký Toàn Thư
    author: Ngô Sĩ Liên (1479)
    reason: "Toàn thư chỉ chép khung 18 đời Hùng Vương, không có hành trạng Lang Liêu"
  - title: Việt Sử Lược
    author: Khuyết danh (c. 1377)
    reason: "Chỉ ghi 18 đời đều gọi Hùng Vương, không kể tích bánh chưng"
adaptations:
  - "Truyện dân gian hiện đại 'Sự tích bánh chưng bánh giầy' (sách giáo khoa Ngữ Văn lớp 6)"
...
motifs:
  - code: null
    system: custom
    description: "Người con bị bỏ quên thắng cuộc thi kế vị nhờ đức và thần trợ"
  - code: null
    system: custom
    description: "Anh hùng văn hóa: thần dạy, người làm, tri thức nông nghiệp được thiêng hóa"
  - code: null
    system: custom
    description: "Giấc mộng chỉ dẫn: tri thức đến trong mộng, người nhận tự tay thực hiện"
popularity: 4
status: published
...
**Thần nhân trong mộng.** LNCQ gọi là 神人, không tên. Một số bài bình giải đương đại trên mạng, dẫn _Việt điện u linh_, đồng nhất vị này với Hậu Tắc (后稷), thần lúa của kinh điển Trung Hoa. Văn bản LNCQ không có căn cứ cho đồng nhất đó; nó là cách đọc của người thời nay.
...
|---|---|---|---|
| Tên nhân vật | 郎僚 Lang Liêu | 薛郎僚 Tiết Liêu, thành Hùng Chiêu Vương | Tiết Liêu / Lang Liêu (tùy bản) |
| Số anh em | 22 quan lang | Không cụ thể | "20 người con" |
| Thứ tự | Con thứ mười tám | Con thứ mười tám, thành vua thứ bảy | Con thứ mười tám |
| Người mẹ | Không tên, "phận thấp, đã mất" | Không nhắc | Không tên, cảnh mất tả tỉ mỉ |
| Thần giúp | 神人 thần nhân (ẩn danh) | Không nhắc | Thần nhân / thần nông (tùy bản) |
| Tên bánh tròn | 薄持餅 bạc trì bính | Bánh giầy | Bánh giầy / bánh dầy |
| Kết cục | Kế vị; 21 anh lập làng | Lên ngôi Hùng Chiêu Vương | Kế vị; phong tục Tết ra đời |
...
**Giáo dục.** "Sự tích bánh chưng bánh giầy" là bài học về thể loại truyền thuyết trong chương trình _Ngữ Văn lớp 6_, có mặt ở mọi bộ sách hiện hành. Lang Liêu theo đó là một trong những hình mẫu đầu tiên trẻ em Việt gặp trong nhà trường về đạo hiếu và giá trị của lao động giản dị.

**Nghệ thuật.** Ấn bản _Lĩnh Nam chích quái_ do Tạ Huy Long minh họa (NXB Kim Đồng, 2017) dựng lại hình ảnh Lang Liêu và hai thứ bánh bằng ngôn ngữ đồ họa hiện đại, đưa nhân vật đến một thế hệ độc giả mới.
...
**Thi viện misattribution.** Một số trang mạng gán nhầm LNCQ cho Nguyễn Dữ. Nguyễn Dữ là tác giả _Truyền Kỳ Mạn Lục_, một tác phẩm khác.
