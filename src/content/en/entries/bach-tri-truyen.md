---
id: bach-tri-truyen
name_vi: "Bạch Trĩ truyện (Truyện chim trĩ trắng)"
name_han: 白雉傳
aliases:
  - Sự tích Việt Thường hiến bạch trĩ
  - Truyện chim trĩ trắng
  - Tale of the White Pheasant
name_en: "Bạch Trĩ Truyện: The Tale of the White Pheasant"
category: tich-co
subcategories:
  - truyen-ky
  ...
  - ngoai-giao-co-dai
type: narrative
era: "Narrative setting: reign of Hùng Vương, during the Western Zhou under King Chéng (c. 1042-1021 BCE). Composition: late 14th c. (Trần Thế Pháp), redacted 1492-1493 (Vũ Quỳnh and Kiều Phú)"
region: bac
locations:
  - Capital of Văn Lang (court of Hùng Vương)
  - Hào Jīng (鎬京), capital of Western Zhou
  - Maritime route via Phù Nam (Funan) and Lâm Ấp (Linyi/Champa)
characters:
  - id: hung-vuong
    role: sovereign
    notes: "King of Văn Lang. Sends his minister to the Zhou court under the name 'Việt Thường thị.' Which generation is unspecified."
  - id: null
    name: Envoy of Việt Thường thị (越裳氏)
    role: protagonist
    notes: "Minister of Hùng Vương, styling himself 'Việt Thường thị.' No personal name in the original."
  - id: null
    name: King Chéng of Zhou (周成王)
    role: counterpart
    notes: "Zhou sovereign. In the story, the actual interlocutor is the Duke of Zhou (regent)."
  - id: null
    name: Duke of Zhou, Zhōu Gōng Dàn (周公旦)
    role: counterpart
    notes: "Regent of Zhou. The one who speaks with the envoy, refuses the position of overlord, and quotes the Yellow Emperor's injunction against violating Giao Chỉ."
contained_in:
  - title: Lĩnh Nam Chích Quái
    position: "Story no. 10 in the upper fascicle (Vũ Quỳnh recension, 22 stories, 1492)"
    author: Trần Thế Pháp (composed late 14th c.), Vũ Quỳnh and Kiều Phú (redacted 1492-1493)
  - title: Đại Việt Sử Ký Toàn Thư
    position: "Ngoại kỷ vol. I, Hùng Vương era (abbreviated version)"
    author: Ngô Sĩ Liên (1479)
  - title: Việt Sử Lược
    position: "Hùng Vương section (condensed)"
    author: Anonymous (c. 1377)
  - title: Khâm Định Việt Sử Thông Giám Cương Mục
    position: "Hùng Vương section"
    author: Imperial Historiography Office, Nguyễn dynasty (1856-1881)
not_contained_in:
  - title: Việt Điện U Linh Tập
    author: Lý Tế Xuyên (1329)
    reason: "Only records spirits officially invested by the court. Việt Thường thị is not a spirit."
adaptations: null
sources:
  - title: Lĩnh Nam Chích Quái
    author: Trần Thế Pháp (composed late 14th c.), Vũ Quỳnh and Kiều Phú (redacted 1492-1493)
...
themes:
  - doc-lap-chu-quyen
  - trao-doi-van-hoa-ngang-hang
  - tim-dao-de-hoc
  - ban-sac-dan-toc
  - viet-hoa-co-tich-trung-hoa
  - ngoai-giao-thuong-co
  - kien-tao-ky-uc
  - chim-vat-to-viet-co
motifs:
  - code: null
    system: custom
    description: "Seeking the Way: envoy comes to find a sage, bearing his own culture as a gift, not tribute"
  - code: null
    system: custom
    description: "Bird as totem: white pheasant is both a Chinese auspicious omen and a symbol of Đông Sơn bird-totem culture"
  - code: null
    system: custom
    description: "Sovereignty proclaimed through the adversary's mouth: the Duke of Zhou quotes the Yellow Emperor forbidding violation of Giao Chỉ"
  - code: null
    system: custom
    description: "South-pointing chariot: anachronism (not invented in Western Zhou), symbolizing the Duke's courteous escort homeward"
  - code: null
    system: custom
    description: "'Forgetting the way home': the envoy's lingering presence symbolizes Việt Thường's cultural footprint on northern soil"
  - code: null
    system: custom
    description: "Chóng yì (重譯): multiple layers of translation, marking two entirely alien civilizations meeting for the first time"
popularity: 3
status: published
...
In the days when the house of Zhou was newly risen in the north, its king, Chéng, was still a boy, and the affairs of the realm rested with his uncle, the Duke of Zhou, who governed as regent. The Duke set down the rites, composed the music, and kept the country at peace, and word of him traveled out along the roads to the four quarters. The gatekeepers of Hào Jīng, the Zhou capital, were used to travelers of every kind. Yet one day even they stood and stared.

Outside the gate waited a party of strangers. Their hair was cut short. They went bareheaded under the sun. Their feet were bare, and their skin was marked with tattooed patterns. They carried a bamboo cage, and in the cage was a pheasant white from crest to tail, a bird no one in the land of Zhou had ever seen. The guards questioned them. The strangers answered. And of everything they said, not one word could anyone at the gate understand.

The officials of Zhou went looking for an interpreter. The first listened and shook his head. A second had to be found to interpret for the first, and a third for the second, the words passing across several tongues before they came out as sense. Only then did the court learn who the visitors were: they called themselves Việt Thường thị, servants of Hùng Vương, king of Văn Lang, a country in the far south beyond mountains and sea, where no man of Zhou had ever set foot.

This was the reason for their journey. In the south, the sky had gone three years without driving rain or violent wind, and for three years the sea had raised no great waves. The people of the south watched the sky and the water and said to one another: when heaven and earth stay calm this long, there must be a sage in China. So Hùng Vương sent a minister north to see this sage with his own eyes, and gave him a white pheasant, a rare bird of the southern mountains, to carry as a gift of first meeting.

The Duke of Zhou had the visitors brought in. He asked how people lived in their country. The envoy told him: in my land, men cut their hair short, go bareheaded, tattoo their bodies, and walk barefoot. Customs the court of Zhou had never heard described. The regent of all the northern world, it turned out, knew nothing of the country of the men standing before him.

Then the Duke asked: "Why have you come?"

The envoy answered: "For three years there has been no driving rain or violent wind, and for three years the sea has raised no great waves. We supposed that China must have a sage. So we came."

The answer left the Duke silent for a moment. These men asked for no title and no favor. They had heard heaven and earth announce a sage, so they crossed mountains and sea to find him, and they brought the finest bird of their own country as a gift for the meeting. The Duke sighed and said: "Where our writ does not run, a gentleman does not compel obedience. Where our virtue has not reached a people, a gentleman does not accept their gifts." The house of Zhou had never done anything for the lands of the south; the Duke would not sit as an overlord and take what was not owed him. And he recalled the words the Yellow Emperor had left long before: "Giao Chỉ is far away, beyond our realm. It must not be violated."

The envoy stayed a while in the land of Zhou. When the time came to leave, he said he had forgotten the way home. The Duke did not press his guest to stay. He ordered five carriages built, each carrying a wooden figure with an outstretched arm, and however the wheels turned, the arm swung back to point south. Men called them south-pointing chariots. These five the Duke gave the envoy to lead him home.

The party took the carriages and followed the coast, past the land of Phù Nam, past the land of Lâm Ấp, and after a full year on the road they reached their own country. And ever since, people say, when envoys set out on far journeys, a south-pointing chariot goes ahead to show the way.

---

## The plot as recorded in _Lĩnh Nam Chích Quái_
...
## Two readings: _"tribute" or "seeking the Way"?_
...
**(vii) The envoy "forgets the way home."** He made the journey once; he can make it back. "Forgetting" is not literal. It symbolizes the cultural footprint of Việt Thường on northern soil: the envoy has stayed long enough to leave an impression, and the northern court sends him off with five south-pointing chariots engineered to head straight south. (The south-pointing chariot is anachronistic. It did not exist in the Western Zhou period, probably not for another 600 to 1,000 years. But chronological slippage like this is standard in origin legends and does not affect the symbolic reading.)

Every textual signal converges on one declaration: **the Việt people are not part of China. They are an independent nation, outside China, with a culture of their own, equal enough for exchange, and China is forbidden from encroaching.** The "tribute" reading maps the story onto the *Hòu Hànshū* template. The "seeking the Way" reading rests on the details the Vietnamese authors added to that template. Both readings remain in circulation, and the sections below present both. What needs no reading at all is what the added details themselves declare: the Việt stood outside China, independent and inviolable.

## The white pheasant: _totem in Việt eyes, omen in Zhou eyes_
...
Carrying a white pheasant across a thousand leagues is therefore an act of bringing your own culture to introduce it to the northerners, not an act of presenting tribute. The pheasant is simultaneously an auspicious omen in the Duke's eyes and a Đông Sơn totemic emblem in the Vietnamese author's eyes.

## Origins: _Vietnamizing a Chinese classic_
...
**Wén Xuǎn, Dōng Jīng Fù** (Zhāng Héng, 78-139): "Then Việt Thường presented its white pheasant."
...
## Position within _Lĩnh Nam Chích Quái_

Story no. 10 in the upper fascicle of the Vũ Quỳnh recension (1492). It sits at a **hinge point** between the cosmogonic myths (Hồng Bàng, Ngư Tinh, Hồ Tinh, Mộc Tinh), the customs-origin cluster (betel, bánh chưng, watermelon), the hero tales (Đổng Thiên Vương), and the "diplomatic-political history" cluster (Bạch Trĩ, Lý Ông Trọng, Kim Quy).
...
Hồng Bàng establishes bloodline. Dạ Xoa establishes the southern frontier (Champa). **Bạch Trĩ establishes equal standing with China from high antiquity.** Kim Quy establishes the succession of An Dương Vương. The pair Hồng Bàng plus Bạch Trĩ equals national birth plus international recognition as equals.

## Present in official histories, _but abbreviated_
...
**Đại Việt Sử Ký Toàn Thư** (Ngô Sĩ Liên, 1479), Ngoại kỷ vol. I: records the event in abbreviated form. Việt Thường thị presents the white pheasant; the Duke of Zhou states that where his writ does not run he does not compel obedience; south-pointing chariots carry the envoy home. The Toàn Thư omits the "three years of calm seas" detail.

**Việt Sử Lược** (c. 1377): condensed to a single sentence, recording that in the reign of King Chéng of Zhou, Việt Thường thị first came to present a white pheasant.
...
## Variant manuscripts: _where the texts diverge_
...
Differences are minor. Ms. A.2914 closes with: "Văn Lang was a place not yet civilized, with no court affairs and no political framework, so [Confucius] did not record it." The common VHv.1473 version reads: "Văn Lang was a remote and uncultivated place, lacking literary tradition, so [Confucius] left it blank." The shade differs: "not yet civilized" (A.2914) is gentler than "remote and uncultivated" (VHv.1473).

The Toàn Thư strips the story down to bare events: no quoted dialogue, just the frame. The *Việt Sử Lược* is even shorter.

## Scholarly debate: _where the story sits in bigger arguments_
...
**Nguyễn Hữu Vinh and Trần Đình Hoành** (2015) offer the "seeking the Way" reading: analyzing each textual detail to show that the story emphasizes independence, equality, and cultural exchange, not tribute.

**What remains open.** The dating question (when the story took shape) and the meaning question (what the story says) are separate questions. On dating, Kelley and Taylor agree the story took shape late, on the scaffolding of Chinese classics; no earlier textual witness has been produced. On meaning, the two readings stand opposed: Kelley reads through the tribute frame; Nguyễn Hữu Vinh and Trần Đình Hoành read through the very details the Vietnamese authors **added** to their Chinese sources (the Duke's disclaimer, the Yellow Emperor's prohibition, the thoroughgoing mutual incomprehension), details found in no Chinese text. Their reading has not yet entered Western-language scholarship. One thing sits outside the debate: those added details assert that the Việt were independent, outside the Chinese realm, and inviolable. That assertion is the text's own.
...
The sentence "Giao Chỉ is far away, beyond our realm. It must not be violated," spoken by the Duke of Zhou quoting the Yellow Emperor, is the spiritual ancestor of "Nam quốc sơn hà nam đế cư" ("The southern country's rivers and mountains belong to the southern emperor"). Not through resistance, but through mutual consent: the Việt voluntarily went seeking the Way (no compulsion), and the Zhou voluntarily acknowledged that the Việt stood outside their domain (no coercion). This two-sided voluntariness gives the story its distinctive symbolic force: Đại Việt's sovereignty was neither seized nor granted. It was the natural order of things, recognized as such since the time of the Yellow Emperor and the Duke of Zhou.

## Notes for use

**Historicity.** Bạch Trĩ truyện is not a reliable source for events of the eleventh to tenth centuries BCE. Every chronological element conflicts: the south-pointing chariot appears roughly 600 to 1,000 years after the Western Zhou; Phù Nam and Lâm Ấp post-date the Common Era; the closing line about Confucius is a Vietnamese authorial addition. The story's value lies in its symbolic and ideological meaning, not in factual accuracy.

**The location of Việt Thường.** The early Chinese sources say only "south of Giao Chỉ lies the country of Việt Thường." Maspero (BEFEO 16, 1916), Đinh Gia Khánh (1960), and Kelley (2005) place Việt Thường in central Vietnam (Quảng Bình, Quảng Trị, Hà Tĩnh) or Laos, not in the Văn Lang heartland of the Red River delta. Attaching Việt Thường to the Hùng Vương lineage is a Vietnamese authorial move made after reading the *Hòu Hànshū*.

**Translations differ by base manuscript.** Đinh Gia Khánh follows VHv.1473; Lê Hữu Mục uses A.33; Nguyễn Hữu Vinh collates HV.486 and VHv.1473; Nguyễn Thị Oanh follows A.2914. Compare editions before quoting details.

**Misattribution online.** Some websites (including Thi viện) attribute the LNCQ to Nguyễn Dữ. The LNCQ was composed by Trần Thế Pháp and redacted by Vũ Quỳnh and Kiều Phú; Nguyễn Dữ wrote the *Truyền Kỳ Mạn Lục*, a different work.
