...
gender: nu
era: Pre-Hùng Vương (era of Lạc Long Quân – Hồng Bàng)
year_approx: -2879
region: bac
locations:
  - Mount Long Trang (where she lived with Lạc Long Quân)
  - Phong Châu (Hùng Vương capital, now Phú Thọ)
  - Ngã Ba Hạc (Việt Trì — where the children separated, per Thiên Nam ngữ lục)
  - Đền Mẫu Âu Cơ (Hiền Lương, Hạ Hòa, Phú Thọ)
  - Đền Quốc Mẫu Âu Cơ (Đền Hùng complex, Núi Vặn)
  - Mount Tản Viên (Âu Việt region)
coordinates:
  - 21.3667
  - 104.9833
relations:
  family:
    - Đế Lai (father — per LNCQ, Vũ Quỳnh 1492 version)
    - Đế Lai (former husband — per some earlier LNCQ versions, Âu Cơ appears as wife/concubine)
    - Lạc Long Quân (husband)
    - 100 sons (born from the sac of a hundred eggs)
    - First Hùng Vương (eldest son, followed mother to the mountains)
    - Kinh Dương Vương (father-in-law)
    - Thần Long Nữ / Long Nữ Đồng Đình (mother-in-law)
    - Đế Minh (grandfather-in-law)
    - Thần Nông / Shennong (shared patrilineal ancestor, 3+ generations back)
  allies:
    - Sơn Tinh (per Thiên Nam ngữ lục — aligned with Âu Cơ's mountain lineage)
    - 50 sons who followed her to the mountains
  enemies: []
  artifacts:
    - Sac of a hundred eggs (百卵 bách noãn — the central miraculous object)
sources:
  - title: Lĩnh Nam Chích Quái
    author: Trần Thế Pháp (compiled 14th c.), Vũ Quỳnh – Kiều Phú (edited 1492–1493)
    chapter: "Tale of the Hồng Bàng Clan (鴻龐氏傳), Volume I, Story 1"
    edition: "Đinh Gia Khánh – Nguyễn Ngọc San, NXB Văn học 1960 (repr. NXB Trẻ 2016, 185 pp.); Classical Chinese MS A.1200 — Trần Khánh Hạo ed., Việt Nam Hán Văn Tiểu Thuyết series, Học Sinh Thư Cục Taipei 1992; Đới Khả Lai – Dương Bảo Quân ed., NXB Trung Châu Cổ Tịch, Zhengzhou 1991"
    notes: "At least 11 extant manuscripts: HV 486, VHV 1473, VHV 2914 at the Institute of Sino-Nôm Studies, etc. VHV 1473 contains an additional passage on the Xī Yóu rebellion not found in other versions."
  - title: Lĩnh Nam Chích Quái (annotated)
    author: Trans. Nguyễn Hữu Vinh, commentary Trần Đình Hoành
    chapter: Tale of the Hồng Bàng Clan
    edition: "dotchuoinon.com 2015 (free PDF, version 18/3/2015)"
  - title: Lĩnh Nam Chích Quái (Lê Hữu Mục edition)
    author: Trans. Lê Hữu Mục
    edition: "NXB Khai Trí, Saigon 1961; repr. Trăm Việt 1982"
  - title: Đại Việt sử ký toàn thư (大越史記全書)
    author: Ngô Sĩ Liên
    chapter: "Outer Annals, Volume 1, Hồng Bàng Annals"
    edition: "Completed 1479 under Lê Thánh Tông. Chính Hòa woodblock printing (1697). Trans. Ngô Đức Thọ et al., NXB Khoa học Xã hội 1993. Sino-Nôm parallel text: dvsktt.com"
    notes: "Ngô Sĩ Liên added the bracket [tục truyền sinh bách noãn] to separate official history from legend. Changed Âu Cơ from Đế Lai's concubine/wife to his daughter."
  - title: Việt sử lược (越史略)
    author: Anonymous
    chapter: Volume 1
    edition: "c. 1377. Trans. Trần Quốc Vượng, NXB Văn Sử Địa 1960"
    notes: "Earliest surviving Vietnamese history. Contains NO genealogy linking Thần Nông – Đế Minh – Kinh Dương Vương – Lạc Long Quân – Âu Cơ. Records only that Hùng Vương at Gia Ninh used magic to subjugate surrounding tribes."
  - title: Việt điện u linh tập (越甸幽靈集)
    author: Lý Tế Xuyên
    edition: "c. 1329. Trans. Lê Hữu Mục, NXB Khai Trí, Saigon 1960"
    notes: "No dedicated entry on Âu Cơ. Records state-protecting deities including Sơn Tinh (Tản Viên Sơn Thánh) but does not connect them to Âu Cơ's genealogy."
  - title: Thiên Nam ngữ lục (天南語錄)
    author: Anonymous
    chapter: "Opening section (within 8,136 lines of lục bát verse)"
    edition: "c. 1682–1709, chữ Nôm. Trans. Nguyễn Thị Lâm – Nguyễn Tá Nhí, NXB Văn học 2001"
    notes: "Records Âu Cơ as 'above fifteen years old.' Directly links Âu Cơ's mountain lineage to Sơn Tinh. Places the children's separation at Ngã Ba Hạc (Việt Trì)."
  - title: Khâm định Việt sử thông giám cương mục (欽定越史通鑑綱目)
    author: Nguyễn Dynasty National History Office
    edition: "Completed under Tự Đức, 1856–1884. Trans. Institute of History, NXB Giáo dục 1998"
    notes: "Rejects the Hồng Bàng genealogy as 'ox-demons and snake-gods, wild and without foundation.' Removes Kinh Dương Vương and Lạc Long Quân from official history."
  - title: The Birth of Vietnam
    author: Keith Weller Taylor
    chapter: "Chapter 1 'Lac Lords' (pp. 1–41), Appendix A (pp. 349–359)"
    edition: "University of California Press, Berkeley 1983"
    notes: "Taylor reads Lạc Long Quân taking Âu Cơ from a northern king as a symbol of cultural resistance/appropriation against China. Cites Pryzluski: the idea of power originating from the sea directly opposes Chinese-Indian continental culture."
  - title: A History of the Vietnamese
    author: Keith Weller Taylor
    edition: "Cambridge University Press, 2013"
    notes: "Stresses 'sharp discontinuities' in Vietnamese history that mythology obscures."
  - title: "The Biography of the Hồng Bàng Clan as a Medieval Vietnamese Invented Tradition"
    ...
    notes: "Central argument: the Hồng Bàng genealogy is a medieval invention, not folk memory from the 1st millennium BCE. Vũ Quỳnh's 1492 preface is written from a Chinese perspective. Some textual elements 'do not predate the Tang dynasty.'"
  - title: "What 'Folk' Created the Lĩnh Nam Chích Quái?"
    author: Liam C. Kelley (Le Minh Khai)
    edition: "leminhkhai.blog (multiple posts, 2010–2020)"
    notes: "Scholarly blog analyzing individual LNCQ tales, questioning the assumption of oral folk origins."
  - title: "A Mythographical Journey to Modernity: The Textual and Symbolic Transformations of the Hùng Kings Founding Myths"
    ...
    notes: "Identifies Âu Cơ as a 'bird goddess' in South Asian / Southeast Asian mythology (citing Phan Đăng Nhật, 1981). Traces a matrilineal → patrilineal reversal between the original LNCQ and Ngô Sĩ Liên's 1479 version. Cites Anne Birrell's concept of 'ornithomorphous hierogamy.'"
  - title: Postcolonial Vietnam — New Histories of the National Past
    author: Patricia Pelley
    edition: "Duke University Press, 2002"
    notes: "Notes that the Hanoi Institute of History 'established' the founding date of 2879 BCE — placing Âu Cơ before even the Chinese Xia dynasty."
  - title: "Classical Primordialism and the Historical Agendas of Vietnamese Confucianism"
    author: Alexander Woodside
    chapter: "In Rethinking Confucianism (eds. Benjamin Elman, John Duncan, Herman Ooms), pp. 116–143"
    edition: "UCLA, 2002"
  - title: The People between the Rivers
    author: Catherine Churchman
    edition: "Rowman & Littlefield, 2016"
    notes: "Bronze drum culture disappeared from the Vietnamese lowlands after Mã Viện's conquest (1st century CE)."
  - title: "Études d'histoire d'Annam. IV. Le Royaume de Van-lang"
    author: Henri Maspero
    chapter: "BEFEO, Tome 18, no. 3 (1918), pp. 1–36"
    edition: "Paris: EFEO"
    notes: "Maspero treats the Hồng Bàng legend (including Âu Cơ) as mythology without historical basis. Proposes 'Văn Lang' is a scribal error for 'Dạ Lang' (夜→文). Uses euhemeristic method."
  - title: "Première étude sur les sources annamites de l'histoire d'Annam"
    ...
    edition: "Paris: EFEO"
    notes: "First Western survey of Vietnamese historical sources, including LNCQ and ĐVSKTT."
  - title: "Bibliographie annamite"
    author: Émile Gaspardone
    chapter: "BEFEO, Tome 34 (1934), pp. 1–173"
    edition: "Paris: EFEO"
    notes: "Standard bibliographic reference for colonial-era Vietnamese textual studies."
  - title: "Notes sur les origines du peuple annamite"
    author: Léonard Aurousseau
    chapter: "BEFEO, Tome 23 (1923)"
    edition: "Paris: EFEO"
    notes: "Theory of Vietnamese migration from Zhejiang, built on Chavannes. Now rejected."
  ...
  - title: Việt Nam văn hóa sử cương
    ...
    notes: "Đào Duy Anh reads the tale of Âu Cơ's division of children as symbolizing the dispersal of the Việt tribes into the Hundred Việt."
  - title: "The Flood Myth and the Origin of Ethnic Groups in Southeast Asia"
    ...
    notes: "Collects 307 flood myths in Vietnam. The gourd/sac birth motif is common across Southeast Asia."
  - title: "Peoples of the Gourd: Imagined Ethnicities in Highland Southeast Asia"
    ...
    notes: "Analyzes the born-from-a-gourd motif as a mechanism for constructing ethnic hierarchy."
  - title: "Annals of the Hồng Bàng Clan: From Ancient Legend to Modern Molecular Biology Evidence"
    ...
    notes: "Cross-references molecular genetic data against the Hồng Bàng genealogy."
summary: "Âu Cơ is a mountain fairy, wife of Lạc Long Quân. She gave birth to a sac of eggs, which hatched into a hundred sons. The couple divided the children: 50 followed their mother to the mountains, 50 followed their father to the sea. The eldest son who stayed with his mother founded the kingdom of Văn Lang and became the first Hùng Vương. The hundred sons are the ancestors of the Hundred Việt. This is the origin of the phrases 'con Rồng cháu Tiên' (children of the Dragon, grandchildren of the Fairy) and 'đồng bào' (同胞, of one womb). The earliest written record appears in Lĩnh Nam Chích Quái (14th c.); Đại Việt sử ký toàn thư (1479) incorporated it into official history. Scholars continue to debate whether it reflects ancient folk memory or medieval literary invention."
group: Founding ancestors of the Vietnamese people
themes:
  - khai-nguyen-dan-toc
  - mau-he-phu-he
  - nui-bien-nhi-nguyen
